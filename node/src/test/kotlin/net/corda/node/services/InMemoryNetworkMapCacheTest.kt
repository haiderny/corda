...
class InMemoryNetworkMapCacheTest {
    ...
    fun `key collision`() {
        ...
        val nodeA = network.createNode(null, -1, MockNetwork.DefaultFactory, true, X509Utilities.getDevX509Name("Node A"), null, entropy, ServiceInfo(NetworkMapService.type))
        val nodeB = network.createNode(null, -1, MockNetwork.DefaultFactory, true, X509Utilities.getDevX509Name("Node B"), null, entropy, ServiceInfo(NetworkMapService.type))
